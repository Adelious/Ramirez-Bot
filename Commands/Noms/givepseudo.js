...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("givepseudo")
    .setDescription("setup le nom rp de tlm sur le server").setDefaultMemberPermissions(PermissionFlagsBits.Administrator),
  async execute(interaction) {
    ...
    guild.members.cache.forEach(async (member) => {
      ...
      if ((await member.nickname) !== null)
        return await console.log(member.nickname + " à déjà un nom rp");
